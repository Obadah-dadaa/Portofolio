      ...
      <div className="relative z-10 text-center px-5 max-w-3xl mx-auto">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-2 px-7 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold text-sm shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/55 transition-shadow duration-300"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-2 px-7 py-3 rounded-xl border border-white/15 text-slate-200 font-semibold text-sm hover:border-indigo-400 hover:bg-indigo-500/10 transition-all duration-200"
          >
            Get In Touch
          </motion.button>
        </motion.div>
        ...
        >
          {SOCIALS.map((s, i) => (
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="w-11 h-11 flex items-center justify-center rounded-xl border border-white/10 bg-white/5 text-slate-400 hover:border-indigo-400 hover:text-indigo-300 hover:bg-indigo-500/10 transition-all duration-200"
            >
              <s.icon size={18} />
            </motion.a>
          ))}
